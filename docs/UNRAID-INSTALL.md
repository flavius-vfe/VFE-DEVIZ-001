...
Versiune recomandată: `0.1.5`. Instalarea nu folosește reverse proxy; accesul este direct prin IP-ul LAN sau prin VPN-ul existent.
...
- imagine: `ghcr.io/flavius-vfe/vfe-deviz-backend:0.1.5`;
- rețea: `vfe-deviz`;
...
- imagine: `ghcr.io/flavius-vfe/vfe-deviz-worker:0.1.5`;
- rețea: `vfe-deviz`;
...
- imagine: `ghcr.io/flavius-vfe/vfe-deviz-frontend:0.1.5`;
- rețea: `vfe-deviz`;
