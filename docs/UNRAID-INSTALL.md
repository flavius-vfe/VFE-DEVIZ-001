...
Versiune recomandată: `0.2.0`. Instalarea nu folosește reverse proxy; accesul este direct prin IP-ul LAN sau prin VPN-ul existent.
...
- imagine: `ghcr.io/flavius-vfe/vfe-deviz-backend:0.2.0`;
- rețea: `vfe-deviz`;
...
- imagine: `ghcr.io/flavius-vfe/vfe-deviz-worker:0.2.0`;
- rețea: `vfe-deviz`;
...
- imagine: `ghcr.io/flavius-vfe/vfe-deviz-frontend:0.2.0`;
- rețea: `vfe-deviz`;
...
Pentru aprovizionare, configurează mai întâi `Proiect → Setări → Adresă livrare`, apoi introdu costurile în `Aprovizionare → Transport`. În fila `Comparație` poți calcula furnizorul preferat, cel mai ieftin furnizor unic sau mixul optim. Blochează planul înainte de comandarea manuală și descarcă lista PDF/XLSX; aplicația nu plasează comenzi la retaileri.
