...
export default function ProjectPage() {
  ...
  return <main>
    ...
    <header><div><h1>{project?.name || "Proiect indisponibil"}</h1>{project && <div className="muted">{project.locality}, {project.county}</div>}</div><a href="/">Înapoi la proiecte</a></header>
